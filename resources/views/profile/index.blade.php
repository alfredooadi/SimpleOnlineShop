       ...
       <div class="col-md-12">
           <div class="card">
               <div class="card-header">
                    <h2><i class="bi bi-person-circle"></i> My Profile</h3>
                </div>
                <div class="card-body">
            ...
            <div class="card">
                ...
                <form method="POST" action="{{ url('profile') }}">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <textarea name="alamat" id="alamat" cols="30" rows="10" class="form-control @error('alamat') is-invalid @enderror" required autocomlete="alamat" autofocus></textarea>
